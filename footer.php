...
<footer class="footer">
	<div class="container">
		<div class="row footer__container">
			<div class="footer__copyright">Копирайт © <?php echo date('Y') ?> ТехноЛОК. <br> Все права защищены.</div>
			<div class="footer__contacts">
				<?php if (have_rows('phone_main', 'option')) : ?>
					<?php while (have_rows('phone_main', 'option')) : the_row();
						...
						<a class="footer__tel" href="tel:<?php echo $tel_main ?>"><?php the_sub_field('phone_main-tel') ?></a>
					<?php endwhile; ?>
				<?php endif; ?>
				<a class="footer__mail" href="mailto:<?php echo $email ?>"><?= $email ?></a>
			</div>
			<div class="footer__button">
				<button class="button button_fill button_w-icon" type="button" data-src="#modal-call" data-fancybox>
					<img src="<?php echo get_template_directory_uri() ?>/assets/images/call-icon.png" alt="" width="23"
							 height="22">
...
<?php get_template_part('template-parts/partial/modal'); ?>
<?php wp_footer(); ?>
</body>
</html>
