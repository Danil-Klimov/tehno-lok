  ...
  if( have_posts() ) {
    while( have_posts() ) {
      ...
      if( $wp_query->current_post % 2 ) {
        $return_html .= '<div class="our-projects__bg-element our-projects__bg-element_right" style="background-image: linear-gradient(270deg, rgba(0,151,209, 0.2) 0%, rgba(0,151,209, 0.2) 100%), url(' . get_template_directory_uri() . '/img/our-projects-right-bg.jpg)"></div>';
      } else {
        $return_html .= '<div class="our-projects__bg-element our-projects__bg-element_right" style="background-image: url(' . get_template_directory_uri() . '/img/our-projects-right-bg.jpg)"></div>';
      }
      $return_html .= '</div>';
      $return_html .= '</section>';
    }
