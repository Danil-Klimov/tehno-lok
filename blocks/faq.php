  ...
  <div class="container">
    <div class="row">
      ...
      <div class="faq__container big-square">
        ...
        <svg class="faq__mask" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="100%" height="100%">
          <defs>
            <mask id="hole1">
      ...
      <div class="faq__footer">
        <button class="button button_fill"
                type="button"
                data-src="#modal-question" data-fancybox>ЗАДАЙТЕ ВАШ ВОПРОС</button>
      </div>
    </div>
  </div>
</section>