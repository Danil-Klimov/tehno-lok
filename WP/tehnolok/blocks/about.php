...
<!-- TODO когда будут страницы проектов, проверить этот блок -->
    ...
    <div class="about__projects">
      <div class="about__projects-wrap">
        ...
        <?php if ( $about_projects ) : ?>
          <?php foreach ( $about_projects as $post ) : ?>
            <?php setup_postdata ( $post ); ?>
            <a class="about__project"
               href="<?php the_permalink(); ?>"
               style="background-image: linear-gradient(to bottom, rgba(23, 98, 175, 0.6) 0%, transparent 175px), url(<?php the_post_thumbnail_url( '345x540' ); ?>)">
