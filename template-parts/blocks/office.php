								...
								<div class="office__slide swiper-slide">
									<?php if ($slide_images) : ?>
										<?php foreach ($slide_images as $slide_image): ?>
											<a class="zoom" href="<?php echo esc_url($slide_image['url']); ?>" data-fancybox>
												<picture>
													<source srcset="<?php echo esc_url($slide_image['sizes']['545x200']); ?>"
																	media="(max-width: 575px)">
													<source srcset="<?php echo esc_url($slide_image['sizes']['360x500']); ?>"
																	media="(max-width: 992px)">
													<source srcset="<?php echo esc_url($slide_image['sizes']['630x355']); ?>"
																	media="(max-width: 1200px)">
													<img src="<?php echo esc_url($slide_image['sizes']['750x500']); ?>"
															 alt="<?php echo esc_attr($slide_image['alt']); ?>"
															 width="<?php echo $slide_image['sizes']['750x500-width']; ?>"
															 height="<?php echo $slide_image['sizes']['750x500-height']; ?>"/>
												</picture>
											</a>
										<?php endforeach; ?>
									<?php endif; ?>
