<section class="request">
	<div class="container">
		<div class="row">
			<?php if (get_sub_field('request_view') === 'w_map') : ?>
				<div class="request__container request__container_left">
					...
					<div class="request__contacts">
						<div class="request__phones">
							<?php if (have_rows('phone_main', 'option')) : ?>
								<?php while (have_rows('phone_main', 'option')) : the_row();
									...
									<div class="request__phones-item">
										<a href="tel:<?php echo $tel_main ?>"><?php the_sub_field('phone_main-tel') ?></a>
							...
							<?php if (have_rows('phone_sub', 'option')) : ?>
								<?php while (have_rows('phone_sub', 'option')) : the_row();
									...
									<div class="request__phones-item">
										<a href="tel:<?php echo $tel_sub ?>"><?php the_sub_field('phone_sub-tel') ?></a>
						...
						<a class="request__mail" href="mailto:<?php echo $email ?>"><?php echo $email ?></a>
			...
			<?php endif; ?>
			<div class="request__container<?= get_sub_field('request_view') !== 'simple' ? ' request__container_right' : ''; ?>">
				<div class="request__header">
					<div class="vertical-text">
						<?php echo get_sub_field('request_view') === 'simple' ? get_field('request_vertical-text', 'option') : 'ОБРАТНАЯ СВЯЗЬ'; ?>
					</div>
					...
					<label class="checkbox">
						...
						<p>Вы соглашаетесь с
							<a href="<?php echo esc_url($policy_link['url']); ?>"
								 target="<?php echo esc_attr($policy_link['target']); ?>">политикой персональных данных
							</a>, нажимая кнопку
						</p>
					</label>
