							...
							<div class="interview__slide swiper-slide">
								<div class="interview__video video-border">
										...
										<div class="video">
											<?php if (get_sub_field('video-online')) : ?>
												<a class="video__link" href="<?php the_sub_field('video-online'); ?>">
													...
													<?php if ($video_cover) : ?>
														<picture>
															<source srcset="<?php echo esc_url($video_cover['sizes']['515x290']); ?>"
																			media="(max-width: 768px)">
															<source srcset="<?php echo esc_url($video_cover['sizes']['620x450']); ?>"
																			media="(max-width: 992px)">
															<source srcset="<?php echo esc_url($video_cover['sizes']['820x460']); ?>"
																			media="(max-width: 1200px)">
															<img class="video__media"
																	 src="<?php echo esc_url($video_cover['sizes']['630x355']); ?>"
																	 alt="<?php echo esc_attr($video_cover['alt']); ?>"
																	 width="<?php echo $video_cover['sizes']['820x460-width']; ?>"
																	 height="<?php echo $video_cover['sizes']['820x460-height']; ?>">
														</picture>
													<?php endif; ?>
												</a>
											<?php else : ?>
									...
									<?php else : ?>
										...
										<?php if ($video_local) : ?>
											<video src="<?php echo esc_url($video_local['url']); ?>" controls></video>
										<?php endif; ?>
									<?php endif; ?>
								</div>
								<div class="interview__text">
									...
									<?php if ($link) : ?>
										<a class="button button_fill" href="<?php echo esc_url($link['url']); ?>"
		...
		<?php if ($interview_button) : ?>
			<div class="row">
				<div class="interview__footer">
					<a class="button button_empty" href="<?php echo esc_url($interview_button['url']); ?>"
						 target="<?php echo esc_attr($interview_button['target']); ?>">
						<?php echo esc_html($interview_button['title']); ?>
					</a>
				</div>
			</div>
		<?php endif; ?>
