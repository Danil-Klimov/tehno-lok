<?php
$title_left = get_sub_field('our-projects-f-p_title')['left'];
		...
		<section class="our-projects our-projects_clean<?= $key % 2 ? ' our-projects_backwards' : '' ?>">
			<div class="our-projects__wrapper">
					...
					<div class="row">
						<?php if ($key === 0) : ?>
							<div class="our-projects__header">
								<h2 class="title"><?php echo $title_left ?></h2>
								<h2 class="title"><?php echo $title_right ?></h2>
							</div>
						<?php endif; ?>
								...
								<div class="our-projects__img our-projects__img-slider swiper-container">
											...
											<?php foreach ($project_gallery_images as $project_gallery_image): ?>
												<div class="swiper-slide">
													...
													<div class="our-projects__img-footer">
														<div class="our-projects__img-caption">
															<?php echo esc_html($project_gallery_image['caption']); ?>
														</div>
													</div>
												</div>
											<?php endforeach; ?>
									...
									<div class="our-projects__controls">
										<button class="arrow arrow_sm arrow_light arrow_prev" type="button">
											<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 9 11" fill="currentColor" width="8"
													 height="10">
				...
				<div class="our-projects__bg-element our-projects__bg-element_right"
						 style="background-image: url(<?php echo get_template_directory_uri() ?>/assets/images/our-projects-right-bg.jpg)"></div>
			</div>
					...
					<div class="row">
						<div class="our-projects__buttons">
							<?php if ($our_projects_f_p_link) : ?>
								<a class="button button_empty" href="<?php echo esc_url($our_projects_f_p_link['url']); ?>"
									 target="<?php echo esc_attr($our_projects_f_p_link['target']); ?>">
									<?php echo esc_html($our_projects_f_p_link['title']); ?>
								</a>
							<?php endif; ?>
						</div>
					</div>
