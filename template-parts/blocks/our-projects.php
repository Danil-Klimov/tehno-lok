			...
			<div class="row">
				...
				<div class="our-projects__buttons">
					<button class="button button_fill button_w-icon our-projects__request-btn" type="button"
						...
						<img src="<?php echo get_template_directory_uri() ?>/assets/images/request-icon.png" alt="" width="24" height="23">
						<span>ЗАКАЗАТЬ РАСЧЕТ</span>
					</button>
					<?php $our_projects_link = get_sub_field('our-projects_link'); ?>
					<?php if ($our_projects_link) : ?>
						<a class="button button_empty" href="<?php echo esc_url($our_projects_link['url']); ?>"
							 target="<?php echo esc_attr($our_projects_link['target']); ?>">
							<?php echo esc_html($our_projects_link['title']); ?>
						</a>
					<?php endif; ?>
				</div>
			</div>
