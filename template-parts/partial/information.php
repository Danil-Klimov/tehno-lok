		...
		<div class="row information__body">
			...
			<?php if ($information_img) : ?>
				<div class="information__img">
					<img src="<?php echo esc_url($information_img['sizes']['345x210']); ?>"
							 alt="<?php echo esc_attr($information_img['alt']); ?>"
							 width="<?php echo $information_img['sizes']['345x210-width']; ?>"
							 height="<?php echo $information_img['sizes']['345x210-height']; ?>"/>
				</div>
			<?php endif; ?>
		</div>
	</div>
