			...
			<div class="row">
				<div class="hero__cats">
					<?php while (have_rows('hero_cats')) : the_row(); ?>
						...
						<a class="hero__cats-item" href="<?php echo esc_url($link['url']); ?>"
					...
					<?php if ($hero_cats_button) : ?>
						<div class="hero__cats-button">
							<a class="arrow arrow_sm arrow_dark"
								 href="<?php echo esc_url($hero_cats_button['url']); ?>"
								 target="<?php echo esc_attr($hero_cats_button['target']); ?>">
					...
					<button class="order__request hero__order" type="button" data-src="#modal-request" data-fancybox>
						<img src="<?php echo get_template_directory_uri() ?>/assets/images/calculation-icon.png" alt="" width="45"
								 height="44">
