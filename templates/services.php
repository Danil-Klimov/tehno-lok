			...
			<section class="service">
				<div class="container-fluid service__container">
					<div class="row">
						...
						<div class="service__text<?php echo $query->current_post % 2 ? ' service__text_left' : ''; ?>">
									...
									<?php while (have_rows('services-carcas')) : the_row(); ?>
										<div class="service__footer-item">
											...
											<div class="service__footer-img">
												...
												<?php if ($img) : ?>
													<a href="<?php echo esc_url($img['url']); ?>" data-fancybox>
														<img src="<?php echo esc_url($img['sizes']['200x130']); ?>"
																 alt="<?php echo esc_attr($img['alt']); ?>"
																 width="<?php echo $img['sizes']['200x130-width']; ?>"
																 height="<?php echo $img['sizes']['200x130-height']; ?>"/>
													</a>
												<?php endif; ?>
											</div>
										</div>
