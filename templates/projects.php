...
<section id="projects">
  ...
  <?php if( $query->have_posts() ) : ?>
    <?php while( $query->have_posts() ): $query->the_post(); ?>
      <section class="our-projects our-projects_clean<?= $query->current_post == 0 ? ' our-projects__w-filter' : ''; ?>">
        <div class="our-projects__wrapper">
                          ...
                          <?php foreach( $project_gallery_images as $project_gallery_image ): ?>
                            <div class="swiper-slide">
                              ...
                              <div class="our-projects__img-footer">
                                <div
                                    class="our-projects__img-caption"><?= esc_html( $project_gallery_image[ 'caption' ] ); ?></div>
                              </div>
                            </div>
                          <?php endforeach; ?>
                        <?php endif; ?>
          ...
          <div class="our-projects__bg-element our-projects__bg-element_right"
               style="background-image: <?= $query->current_post % 2 ? 'linear-gradient(270deg, rgba(0,151,209, 0.2) 0%, rgba(0,151,209, 0.2) 100%),' : ''; ?> url(<?= get_template_directory_uri() ?>/img/our-projects-right-bg.jpg)"></div>
        </div>
      </section>
    <?php endwhile; ?>
  <?php endif;
