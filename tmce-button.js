  ...
  tinymce.PluginManager.add( 'custom_buttons', function( editor, url ) {
    editor.addButton('custom_buttons', {
      ...
      menu: [
          ...
          onclick: function() {
            editor.windowManager.open( {
              ...
              onsubmit: function( e ) {
                ...
                editor.insertContent( '<div class="table"><table>' + table + '</table></div>');
              }
            });
          }
        },
        ...
        //       onsubmit: function( e ) {
        //         let link = '';
        //         if(e.data.link.startsWith('/')) {
        //           link = location.origin + e.data.link;
        //         }
        //         editor.insertContent( '<a class="button" href="' + link + '">' + e.data.text + '</a>');
        //       }
        //     });
        //   }
        // }
